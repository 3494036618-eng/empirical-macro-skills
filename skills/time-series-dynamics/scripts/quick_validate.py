...
REQUIRED = [
    ...
    "scripts/materialize_macro_input_evidence.py",
    "scripts/materialize_public_input_evidence.py",
    "scripts/run_time_series_dynamics.py",
    "scripts/validate_bundle.py",
    "scripts/validate_input_evidence.py",
    "src/time_series_dynamics/contracts.py",
    "src/time_series_dynamics/canonical_loader.py",
    "src/time_series_dynamics/horizon_regression.py",
    "src/time_series_dynamics/input_evidence.py",
    "src/time_series_dynamics/macro_input_evidence.py",
    "src/time_series_dynamics/public_input_evidence.py",
...
def main() -> int:
    ...
    public_input = (
        ROOT / "fixtures" / "public" / "jel-example5-input-evidence"
    )
    input_evidence_path = (
        public_input
        if public_input.exists()
        else ROOT / ".artifacts" / "jel-example5-input-evidence"
    )
